...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round(higher_education[is_rich].shape[0] / higher_education.shape[0] * 100, 1)
    lower_education_rich = round(lower_education[is_rich].shape[0] / lower_education.shape[0] * 100, 1)
